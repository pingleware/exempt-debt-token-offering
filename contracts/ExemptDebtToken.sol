...
import '@sgmfinance/contracts/util/IERC659.sol';
import '@sgmfinance/contracts/util/ERC659data.sol';

abstract contract ExemptDebtToken is IERC659, ERC659data {
  ...
  function setBond(uint256 class, address  bank_contract)public override onlyOwner returns (bool) {
